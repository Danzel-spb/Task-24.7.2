...
def test_add_new_pet_with_valid_data(name='СвинПаук', animal_type='свинка', age='3', pet_photo='images/pig.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, 'СуперСвин', 'хрюша', '4', 'images/pig.jpg')
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Karl', animal_type='lemur', age=4):
...
def test_add_new_pet_with_invalid_name(name='', animal_type='dog', age='-6', pet_photo='images/pig.jpeg'):
...
def test_add_new_pet_with_invalid_type(name='Sven', animal_type='55', age='4', pet_photo='images/pig.jpeg'):
...
def test_post_add_new_pet_without_photo(name='Pupsik', animal_type='Cat', age=2):
...
def test_successful_update_pet_info_incorrect(name='Glovar', animal_type='dog', age='two'):
